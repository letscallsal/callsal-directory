...
export const Room3DEnhanced: React.FC<Room3DEnhancedProps> = ({
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      // Portrait mode: camera starts showing diorama framed in white room
      // then zooms out to reveal full room for hero title
      ...
      // Smooth fade for diorama when cinematics/booking overlay opens/closes (~200ms)
      // fadeTarget already computed above in skip-frame check
      const fadeLerp = 0.15; // ~200ms at 60fps
      ...
      // Main Calgary diorama (center of back wall) — portrait frame on mobile, landscape on desktop
      ...
      // Draw centered panel frame shadow (behind HTML content) — hidden on mobile
